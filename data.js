...
const WC = ['#7c6fff','#ff5f7e','#3de0a0','#ffc657','#a29bfe','#fd79a8','#55efc4','#fdcb6e','#74b9ff','#e17055'];
...
const DEF = {
  ...
  wali: [
    ...
    },
    {
      ...
      quote:'PJadilah anak yang tidak hanya pintar secara akademis, tapi juga berakhlak mulia dan siap menghadapi tantangan.',
      foto:null
    },
    {
  ...
  siswa: [
    {no:'01',nama:'Ahmad Fauzi Ramdan',   role:'Ketua Kelas',  foto:null, w:'#7c6fff'},
    ...
    {no:'05',nama:'Eko Prasetyo',          role:'',             foto:null, w:'#a29bfe'},
    ...
    {no:'21',nama:'Ulfa Khoirunnisa',      role:'',             foto:null, w:'#7c6fff'},
    {no:'22',nama:'Vino Bastian',          role:'',             foto:null, w:'#ff5f7e'},
    {no:'23',nama:'Wahyu Santoso',         role:'',             foto:null, w:'#3de0a0'},
    {no:'24',nama:'Xenia Kirana',          role:'',             foto:null, w:'#a29bfe'},
    ...
    {no:'31',nama:'Eva Susanti',           role:'',             foto:null, w:'#7c6fff'},
